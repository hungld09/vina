...
<html>
	<head>
		...
		<link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl ?>/skins/mp3mobile/css/reset.css" type="text/css" />
		<link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl ?>/skins/mp3mobile/css/style.css" type="text/css" />
		<!--[if IE]>
		<link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl ?>/skins/mp3mobile/css/iemobile.css" type="text/css" />
		<![endif]-->
		<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl ?>/skins/mp3mobile/js/zt/zepto.js"></script>
		<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl ?>/skins/mp3mobile/js/zt/event.js"></script>
		<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl ?>/skins/mp3mobile/js/zt/ajax.js"></script>
		<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl ?>/skins/mp3mobile/js/zt/form.js"></script>
	...
	<body class="mobile">
		...
		<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl ?>/skins/mp3mobile/js/mo.common.js"></script>		
	</body>
</html>