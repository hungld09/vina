...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script src="<?php echo Yii::app()->theme->baseUrl . '/js/vina/jquery-1.10.2.js' ?>"></script>
        <script src="<?php echo Yii::app()->theme->baseUrl . '/js/vina/jquery.magnific-popup.min.js' ?>"></script>
        <script src="<?php echo Yii::app()->theme->baseUrl . '/js/vina/main.js' ?>"></script>
        <style>
    ...
    <body>
        ...
        <div class="uploadQuestion" style="position: fixed;z-index: 999999;bottom: 4%;right:15%;">
            <a class="" d href="<?php echo Yii::app()->baseUrl . '/question/upload' ?>"><img width="65px" src="<?php echo Yii::app()->theme->baseUrl .'/img/hoi.png'?>" /></a>
        </div>
    </body>
