<?php
    ...
    class SiteController extends Controller
    {
        ...
        public function actionResetPassword()
        {
            ...
            if ($subId == 0) {
                echo 'Tài khoản reset password không tôn tại';
                die;
            }
        ...
        public function actionConfirmPass()
        {
            ...
            if ($subId == 0) {
                echo 'Lỗi hệ thống, xin vui long liên hệ admin';
                die;
            }
//        $subId = base64_decode($subId);
            if (strlen($pass1) < 4) {
                echo 'Password từ 4 ký tự trở lên';
                die;
            }
            if ($pass1 != $pass2) {
        ...
        public function actionCheckReset()
        {
            ...
            echo('Mail reset đã được gửi, Xin mời bạn truy cập mail để xác minh tài khoản');
            die;
        }
