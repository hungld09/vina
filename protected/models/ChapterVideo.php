...
/**
 * This is the model class for table "chapter_video".
 *
 * The followings are the available columns in table 'chapter_video':
 * @property integer $id
 * @property string $chapter_name
 * @property string $chapter_name_ascii
 * @property integer $subject_id
 */
class ChapterVideo extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, chapter_name, chapter_name_ascii, subject_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ChapterVideo the static model class
	 */
